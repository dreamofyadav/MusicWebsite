...
<div class="image-container">
	<h2>
				...
				String path = "C:\\Users\\Aakash Yadav\\eclipse\\Musicwebsite\\src\\main\\webapp\\movie1";

				File file = new File(path);
				File files[] = file.listFiles();
				for (File f : files) {
					if (f.getName().startsWith(smname))

					{
						String mname1=f.getName(); 
	            		   String imagePath="movie1/"+mname1+"/poster.jpg";
				%>
				<div class="card" style="width: 18rem;">
			
					<img src="<%=imagePath%>"
						alt="Images for <%=f.getName()%>  class="card-img-top"> <br>
					<div class="card-body">
					
					</div>
				</div>
				<a href="play.jsp?smname=<%=f.getName()%>&cat=movie1"> <%=f.getName()%>
				</a> <br>
				<%
				}
				}
							...
							<form class="form-inline subscription-form mailchimp"
								...
								<div class="form-group newsletter-field">
									<input type="email" name="EMAIL" class="form-control"
										id="subscriber-email" placeholder="jane.doe@example.com">
								</div>
								<!-- Subscribe button -->
					...
					<div class="title-section text-center animated out"
						...
						<div class="row">
							<div class="col-sm-8 col-sm-offset-2">
								<h2>Get in touch</h2>
								<hr>
								<p>If you have any complaints or feedback, please fill in the following form and we will get in touch with you, shortlya.</p>
							</div>
						</div>
						<!-- End row -->
					</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-8 col-sm-offset-2">
							...
							<p class="copyright">
								&copy; Musica - Created By <a href="http://templatestock.co">Aakash
									Yadav</a>
							</p>
						</div>
						<!-- End col-sm-8 -->
